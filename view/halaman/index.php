...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="index.html">SD 47 MATARAM<span class="text-primary">.</span></a>
            </div>
    ...
    <div class="ftco-blocks-cover-1">
       <!-- data-stellar-background-ratio="0.5" style="background-image: url('../../assets/style/images/')" -->
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('../../assets/style/images/sd.webp')">
        <div class="container">
    ...
    <footer class="site-footer" style="padding: 20px 0 5px 0">
      <div class="container">
        <p class="text-center"> Developer : <a href="#" target="blank">Charlie Aprizal</a> </p>
        <br><center><p>Repost by <a href='#' title='NIM' target='_blank'>2101020049</a></p></center>
